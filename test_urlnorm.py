...
def pytest_generate_tests(metafunc):
    if metafunc.function in [test_norms]:
        ...
        tests = {
            ...
            'http://test.example/?a=%e3%82%82%26': b'http://test.example/?a=\xe3\x82\x82%26'.decode('utf-8'), # should return a unicode character
            ...
            u'http://XBLA\u306eXbox.com': b'http://xbla\xe3\x81\xaexbox.com/'.decode('utf-8'),
            u'http://XBLA\u306eXbox.com'.encode('utf-8'): b'http://xbla\xe3\x81\xaexbox.com/'.decode('utf-8'),
            u'http://XBLA\u306eXbox.com': b'http://xbla\xe3\x81\xaexbox.com/'.decode('utf-8'),
            # test idna + utf-8 domain
            # u'http://xn--q-bga.XBLA\u306eXbox.com'.encode('utf-8'): b'http://q\xc3\xa9.xbla\xe3\x81\xaexbox.com'.decode('utf-8'),
            'http://ja.wikipedia.org/wiki/%E3%82%AD%E3%83%A3%E3%82%BF%E3%83%94%E3%83%A9%E3%83%BC%E3%82%B8%E3%83%A3%E3%83%91%E3%83%B3': b'http://ja.wikipedia.org/wiki/\xe3\x82\xad\xe3\x83\xa3\xe3\x82\xbf\xe3\x83\x94\xe3\x83\xa9\xe3\x83\xbc\xe3\x82\xb8\xe3\x83\xa3\xe3\x83\x91\xe3\x83\xb3'.decode('utf-8'),
            ...
            "http://test.domain/I%C3%B1t%C3%ABrn%C3%A2ti%C3%B4n%EF%BF%BDliz%C3%A6ti%C3%B8n" : b"http://test.domain/I\xc3\xb1t\xc3\xabrn\xc3\xa2ti\xc3\xb4n\xef\xbf\xbdliz\xc3\xa6ti\xc3\xb8n".decode('utf-8'),
        ...
        for bad, good, unsafe in (
            ...
            ('%E3%82%AD', u'\u30ad', ''),
            ('%96', u'\ufffd', ''),    # https://github.com/jehiah/urlnorm/issues/4
            ):
